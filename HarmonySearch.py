...
PAR = 0.0005  # 0.75 sugerido
IMPROVISACION = 1
BERNOULLI_P = 0.2  #  http://es.wikipedia.org/wiki/Ensayo_de_Bernoulli
MUTATION_P = 0.8  # http://en.wikipedia.org/wiki/Mutation_(genetic_algorithm)
SEED = 0
RANDOM_UNO = 0
